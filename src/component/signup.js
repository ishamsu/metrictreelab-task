 ...
 class Signup extends Component {
  ...
  handleSignup(e) {
    ...
    if (this.checkBtn.context._errors.length === 0) {
        dwuser.createuser(this.state.username, this.state.password).then(
        () => {
      ...
      <div className="col-md-12">
        <div className="card card-container">
          ...
          >
            ...
            <div className="form-group">
              ...
              >
                ...
                <span><strong> ✓</strong> Signup</span>
              </button>
            </div>
          ...
          <footer className="footer">
            ...
            <small  className="form-text text-muted text-center"> have an account <a href='./login'><i className="text-primary" style={{textDecoration:"underline"}}>Login</i></a> </small>
